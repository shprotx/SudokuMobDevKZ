...
object ThemePalettes {
    ...
    val all: List<ThemePalette> = listOf(
        ...
        palette("PRESET_SOLARIZED_LIGHT", R.string.theme_palette_solarized_light, bg = 0xFFFDF6E3, surface = 0xFFEEE8D5, primary = 0xFF1E6FA8, accent = 0xFF6B7D00, text = 0xFF4A6068, textSecondary = 0xFF6E7E7E, error = 0xFFDC322F, gridLine = 0xFFC0B49A, gridLineBold = 0xFF839496, cellFixed = 0xFF586E75, cellEditable = 0xFF1E6FA8, cellSelected = 0xFFBDD6E9, cellHighlight = 0xFFD6E8F4, divider = 0xFFD3C9B2),
        ...
        palette("PRESET_SAKURA", R.string.theme_palette_sakura, bg = 0xFFFFF5F7, surface = 0xFFFFFFFF, primary = 0xFFD14E7E, accent = 0xFFC2456F, text = 0xFF4A2733, textSecondary = 0xFF9E7A86, error = 0xFFE53935, gridLine = 0xFFF3C6D3, gridLineBold = 0xFFC76A8C, cellFixed = 0xFF6D3B4E, cellEditable = 0xFFC2456F, cellSelected = 0xFFFAD1DE, cellHighlight = 0xFFFDE9EF, divider = 0xFFF6E2E8),
        ...
        palette("PRESET_MINT", R.string.theme_palette_mint, bg = 0xFFEFFAF5, surface = 0xFFFFFFFF, primary = 0xFF0E8A66, accent = 0xFF0E8A8E, text = 0xFF13413A, textSecondary = 0xFF5E8C82, error = 0xFFE53935, gridLine = 0xFFB8E6D6, gridLineBold = 0xFF4FA890, cellFixed = 0xFF13413A, cellEditable = 0xFF0E8A66, cellSelected = 0xFFBDEBDC, cellHighlight = 0xFFD9F4EB, divider = 0xFFD2EDE4),
        ...
        palette("PRESET_SAND", R.string.theme_palette_sand, bg = 0xFFF5EFE2, surface = 0xFFFFFBF2, primary = 0xFF9A6E32, accent = 0xFF9A6E32, text = 0xFF4A3B28, textSecondary = 0xFF7E6E52, error = 0xFFC0584B, gridLine = 0xFFDCCBAE, gridLineBold = 0xFFA8895E, cellFixed = 0xFF4A3B28, cellEditable = 0xFF8A5E28, cellSelected = 0xFFE8D8BC, cellHighlight = 0xFFF1E8D4, divider = 0xFFE3D6BC),
        palette("PRESET_LATTE", R.string.theme_palette_latte, bg = 0xFFEFF1F5, surface = 0xFFFFFFFF, primary = 0xFF1E66F5, accent = 0xFF8839EF, text = 0xFF4C4F69, textSecondary = 0xFF6C6F85, error = 0xFFD20F39, gridLine = 0xFFBCC0CC, gridLineBold = 0xFF8C8FA1, cellFixed = 0xFF4C4F69, cellEditable = 0xFF1E66F5, cellSelected = 0xFFCCD0DA, cellHighlight = 0xFFE6E9EF, divider = 0xFFDCE0E8),
        ...
        palette("PRESET_GRUVBOX", R.string.theme_palette_gruvbox, bg = 0xFF282828, surface = 0xFF3C3836, primary = 0xFFFE8019, accent = 0xFFB8BB26, text = 0xFFEBDBB2, textSecondary = 0xFFA89984, error = 0xFFFB4934, gridLine = 0xFF504945, gridLineBold = 0xFF7C6F64, cellFixed = 0xFFEBDBB2, cellEditable = 0xFFFABD2F, cellSelected = 0xFF504945, cellHighlight = 0xFF423E3A, divider = 0xFF504945),
        palette("PRESET_TOKYO_NIGHT", R.string.theme_palette_tokyo_night, bg = 0xFF1A1B26, surface = 0xFF24283B, primary = 0xFF7AA2F7, accent = 0xFFBB9AF7, text = 0xFFC0CAF5, textSecondary = 0xFF9AA5CE, error = 0xFFF7768E, gridLine = 0xFF292E42, gridLineBold = 0xFF565F89, cellFixed = 0xFFC0CAF5, cellEditable = 0xFF7DCFFF, cellSelected = 0xFF2F3549, cellHighlight = 0xFF252A3F, divider = 0xFF292E42),
        palette("PRESET_EVERFOREST", R.string.theme_palette_everforest, bg = 0xFF2D353B, surface = 0xFF343F44, primary = 0xFFA7C080, accent = 0xFFDBBC7F, text = 0xFFD3C6AA, textSecondary = 0xFF9DA9A0, error = 0xFFE67E80, gridLine = 0xFF3D484D, gridLineBold = 0xFF7A8478, cellFixed = 0xFFD3C6AA, cellEditable = 0xFF83C092, cellSelected = 0xFF475258, cellHighlight = 0xFF3A454A, divider = 0xFF4F585E),
        palette("PRESET_ROSE_PINE", R.string.theme_palette_rose_pine, bg = 0xFF232136, surface = 0xFF2A273F, primary = 0xFFC4A7E7, accent = 0xFFEBBCBA, text = 0xFFE0DEF4, textSecondary = 0xFF908CAA, error = 0xFFEB6F92, gridLine = 0xFF393552, gridLineBold = 0xFF6E6A86, cellFixed = 0xFFE0DEF4, cellEditable = 0xFF9CCFD8, cellSelected = 0xFF44415A, cellHighlight = 0xFF2A2740, divider = 0xFF44415A),

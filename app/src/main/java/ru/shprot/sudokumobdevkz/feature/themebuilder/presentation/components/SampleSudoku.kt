...
internal object SampleSudoku {
    ...
    fun cells(): List<List<CellData>> {
        ...
        return listOf(
            ...
            listOf(given(6), empty, notes(1, 2, 8), given(1), given(9), given(5), empty, empty, empty),
            ...
            listOf(given(4), empty, empty, given(8), empty, given(3), notes(2, 5, 8), empty, given(1)),
            ...
            listOf(notes(3, 8), empty, empty, given(4), given(1), given(9), empty, empty, given(5)),
